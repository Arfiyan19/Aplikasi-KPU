...
<form action="/user/{{ $user->id }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" value="{{$user->name}}" id="name" placeholder="Masukkan name">
        @error('name')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" name="password" value="{{$user->password}}" id="password" placeholder="Masukkan Password" hidden>
        @error('password')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="umur" id="umur" placeholder="Masukkan Umur" value="{{ $user->profile->umur }}">
        @error('umur')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" placeholder="Masukkan Harga Satuan" value="{{ $user->profile->tempat_lahir }}">
        @error('tempat_lahir')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" placeholder="Masukkan Tanggal Lahir" value="{{ $user->profile->tgl_lahir }}">
        @error('tgl_lahir')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
    ...
    <div class="form-group">
        ...
        <!-- //input  -->
        <input type="text" class="form-control" name="bio" id="bio" placeholder="Masukkan Bio" value="{{ $user->profile->bio }}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Masukkan Alamat" value="{{ $user->profile->alamat }}">

        <!-- <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Masukkan Alamat">{{$user->profile->alamat}}</textarea> -->
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" name="no_telp" id="no_telp" placeholder="Masukkan Nomor Telepon" value="{{ $user->profile->no_telp }}">
        @error('no_telp')
        <div class="alert alert-danger">
            {{ $message }}
        </div>
